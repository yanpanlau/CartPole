...
class DQNAgent:
    ...
    def build_model(self):
        ...
        x = Dense(16, input_shape=(self.state_size,), activation='relu', kernel_initializer='he_uniform')(input)
        ...
        #fc2 = Dense(16)(x)
        value = Dense(1)(x)
        q_value = merge([advantage, value], mode = lambda x: x[0]-K.mean(x[0])+x[1], output_shape = (self.action_size,))
